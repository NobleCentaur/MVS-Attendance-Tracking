window.onload = function() {
    ...
    xhttp.open("GET", "query-reference.php?value1=8&value2=null", false);
    xhttp.send();
    absences = JSON.parse(xhttp.responseText);
    xhttp.open("GET", "query-reference.php?value1=9&value2=null", false);
    xhttp.send();
    ...
    // get all freshmen
    xhttp.open("GET", "query-reference.php?value1=7&value2="+(currentYear+3), false);
    xhttp.send();
    freshmen = JSON.parse(xhttp.responseText);
    // get all sophomores
    xhttp.open("GET", "query-reference.php?value1=7&value2="+(currentYear+2), false);
    xhttp.send();
    sophomores = JSON.parse(xhttp.responseText);
    // get all juniors
    xhttp.open("GET", "query-reference.php?value1=7&value2="+(currentYear+1), false);
    xhttp.send();
    juniors = JSON.parse(xhttp.responseText);
    // get all seniors
    xhttp.open("GET", "query-reference.php?value1=7&value2="+currentYear, false);
    xhttp.send();
    ...
    */
    ...
    // absences loading
    xhttp.open("GET", "query-reference.php?value1=6&value2=null", false);
    xhttp.send();
